class FLkeyMiniDeviceSetup:
    ...
    def init(self):
        ...
        self._select_pot_layout_mixer_volume()
    ...
    def _select_pot_layout_mixer_volume(self):
        self.sender.send_message(
            *self.product_defs.SurfaceEvent.PotLayout.value, self.product_defs.PotLayout.MixerVolume.value
        )
